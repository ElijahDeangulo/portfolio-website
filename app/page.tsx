          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="https://github.com/ejdeangulo" className="inline-flex items-center justify-center rounded-md border border-border bg-background px-3 py-2 text-sm transition-colors hover:bg-accent hover:text-accent-foreground">
                  🐙
                </a>
